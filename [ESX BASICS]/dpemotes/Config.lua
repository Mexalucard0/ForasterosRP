Config = {
    ...
    -- NOte this might cause an issue of the image getting stuck on peoples screens
        ...
        MenuImage = "https://i.imgur.com/CEWI4Xu.png",
    ...
    Config.ClassRoom = {
        ["Gym"] =  {
            Trainer = { coords = vector3(-1211.33, -1576.22, 3.61), markerSize = 1.5 },
            Students = { coords = vector3(-1218.44, -1580.73, 3.14), markerSize = 15.0 }
        }
    }
    Config.Languages = {
      ['en'] = {
      ...
      ['es'] = {
        ...
        ['danceemotes'] = "🕺 Bailes",
        ['propemotes'] = "📦 Objetos",
        ['favoriteemotes'] = "🌟 Favorita",
        ['favoriteinfo'] = "Selecciona una animacion como su favorita.",
        ['rfavorite'] = "Reiniciar favorito",
        ...
        ['camera'] = "Presione ~y~Z~w~ para usar el flash de la camara. (Menú cerrado)",
        ['makeitrain'] = "Presiona ~y~Z~w~ para hacer llover. (Menú cerrado)",
        ['pee'] = "Mantiene ~y~Z~w~ para mear. (Menú cerrado)",
        ['spraychamp'] = "Mantiene ~y~Z~w~ rociar champán. (Menú cerrado)",
        ['bound'] = "Unida ",
        ['to'] = "a",
