window.APP = {
  ...
  watch: {
    messages() {
      ...
      document.getElementById('image_defcon').classList.add('imgdefconlow');
  ...
  methods: {
    ...
    {
      document.getElementById('image_defcon').src = 'defcon' + defconLevel + '.png';
      document.getElementById('defcon').style.display = 'inline';
    },
    HideDefCon()
    {
      document.getElementById('defcon').style.display = 'none';
    },
    DefConTransparent({value})
    {
      if(value)
      {
        document.getElementById('defcon').style.display = 'none';
    ...
    resetShowWindowTimer() {
      ...
      this.showWindowTimer = setTimeout(() => {
        if (!this.showInput) {
          ...
          document.getElementById('image_defcon').classList.remove('imgdefconlow');
