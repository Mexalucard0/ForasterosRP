...
Config.Base = {
	...
	-- Return vehicle mark 
	retveh  = {x =  -337.41131591797, y = -1023.5138549805, z = 30.384847640991},
	-- Delete vehicle mark
...
Config.DeliveryLocationsVan = {
	{Item1 = {x = -53.904, y = -1764.202, z = 28.957},		Item2 = {x = -41.15, y = -1751.66, z = 29.42}},
	{Item1 = {x = 369.38, y = 317.44, z = 103.21},		Item2 = {x = 375.08, y = 333.65, z = 103.57}},
	{Item1 = {x = -708.32, y = -921.15, z = 18.8},		Item2 = {x = -705.7, y = -905.46, z = 19.22}},
...
Config.Locales = {
	...
	["start_delivery"]            = "Presiona ~y~E~w~ para empezar el reparto dejando una fianza de $",
	...
	["end_delivery"]              = "Presiona ~y~E~w~ para terminar la entrega, sientate en el vehículo o perderas la fianza",
