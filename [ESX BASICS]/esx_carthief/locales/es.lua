Locales['es'] = {
  ...
  ['steal_a_car'] = 'pulsa ~y~E~s~ para robar<br>un vehículo de MoleCorp',
  ['drop_car_off'] = 'pulsa ~y~E~s~ para dejar el vehículo de MoleCorp',
  ['cooldown'] = 'No quedan vehículos en esta ubicación'
}
